    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <div className="flex items-center justify-center gap-4 mb-10">
          ...
          <span className="text-amber-500/90 text-[10px] tracking-[0.5em] uppercase">{t("since")}</span>
          <div className="h-px w-12 md:w-20 bg-amber-500/70" />
        </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="text-[9px] tracking-[0.4em] text-stone-500 uppercase">{t("scroll")}</span>
